...
const COLOR_SWATCHES = [
  ...
  { name: "--color-doodle", variable: "var(--color-doodle)" },
  { name: "--color-doodle-pulse", variable: "var(--color-doodle-pulse)" },
  { name: "--color-background", variable: "var(--color-background)" },
  { name: "--color-foreground", variable: "var(--color-foreground)" },
  { name: "--color-surface-muted", variable: "var(--color-surface-muted)" },
  { name: "--color-border", variable: "var(--color-border)" },
  { name: "--color-border-muted", variable: "var(--color-border-muted)" },
  { name: "--color-border-strong", variable: "var(--color-border-strong)" },
  { name: "--color-text-primary", variable: "var(--color-text-primary)" },
  { name: "--color-text-secondary", variable: "var(--color-text-secondary)" },
  ...
  { name: "--color-decoration", variable: "var(--color-decoration)" },
  { name: "--color-loader-idle", variable: "var(--color-loader-idle)" },
  { name: "--color-loader-active", variable: "var(--color-loader-active)" },
];
